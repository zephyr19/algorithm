...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        else return 1.0 * (y - that.y) / (x - that.x);
    }
    ...
    public Comparator<Point> slopeOrder() {
        return (o1, o2) -> {
            double cmp = slopeTo(o1) - slopeTo(o2);
            if (cmp > 0) {
                return 1;
            } else if (cmp < 0) {
                return -1;
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(cmp.compare(q, r));
        StdOut.println(cmp.compare(q, s));
        StdOut.println(cmp.compare(r, s));
    }
}